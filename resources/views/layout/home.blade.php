...
<html>
  ...
  <!-- Facebook and Twitter integration -->
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="top">
							<div class="row">
								<div class="col-md-6">
									<div id="colorlib-logo"><a href="index.html">Pagsanghan<span>HealthCare</span></a></div>
								</div>
								<div class="col-md-3">
									<div class="num">
										<span class="icon"><i class="icon-phone"></i></span>
										<p><a href="#">555-555-555</a><br><a href="#">09057043976</a></p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="loc">
										<span class="icon"><i class="icon-location"></i></span>
										<p><a href="#">Brgy. Canlapwas, Pagsanghan Samar</a></p>
									</div>
								</div>
							</div>
						</div>
	...
	@section('colorlib-hero')
		<aside id="colorlib-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(../../homepage/images/img_bg_6.jpg);">
		   	...
		   	<li style="background-image: url(../../homepage/images/img_bg_5.jpg);">
		   		<div class="overlay"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
		   	...
		   	<li style="background-image: url(../../homepage/images/img_bg_1.jpg);">
		   		<div class="overlay"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
		   	...
		   	<li style="background-image: url(../../homepage/images/img_bg_2.jpg);">
		   		<div class="overlay"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
	...
	<!-- Sticky Kit -->
	<script src="{{ asset('homepage/js/sticky-kit.min.js') }}"></script>
	<!-- Main -->
